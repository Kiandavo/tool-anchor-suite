...
import { Code, Filter, FileText, Link, Share, RefreshCw, Hash } from 'lucide-react';
...
export default function SeoTool({ slug }: SeoToolProps) {
  ...
  // States for robots.txt generator
  ...
  // New state variables for HTML tools
  ...
  // Auto Shorten Link
  const shortenUrl = () => {
    // For demo, we're just taking the domain
    try {
      const url = new URL(longUrl);
      const shortened = url.hostname;
      setShortUrl(shortened);
      toast.success("لینک کوتاه ایجاد شد");
    } catch (e) {
      toast.error("لطفاً یک URL معتبر وارد کنید");
    }
  };
      ...
      {slug === 'meta-tag-generator' ? (
        ...
        <Card>
          <CardContent className="p-6 space-y-4">
            <div className="space-y-2">
              <Input
                placeholder="لینک اصلی را وارد کنید"
                value={longUrl}
