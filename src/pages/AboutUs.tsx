...
export default function AboutUs() {
  ...
  return (
    <Layout>
      <SeoHead 
        title="درباره لنگر - ابزارهای آنلاین فارسی"
        description="لنگر مجموعه‌ای از ابزارهای کاربردی فارسی است که مستقیم در مرورگر اجرا می‌شوند و اطلاعاتی ذخیره نمی‌کنند."
      ...
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            ساده، سریع و قابل اعتماد باشند. ما یک تیم کوچک از توسعه‌دهندگان ایرانی هستیم که 
            معتقدیم ابزارهای دیجیتال باید در دسترس همه باشند.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            تمام ابزارها در مرورگر شما اجرا می‌شوند و هیچ اطلاعاتی به سرور ارسال نمی‌شود.
          </p>
        </section>
