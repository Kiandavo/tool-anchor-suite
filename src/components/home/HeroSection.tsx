...
export const HeroSection = () => {
  return (
    <section className="py-28 sm:py-36 mb-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white via-white to-blue-100" />
      <div className="absolute inset-0 bg-gradient-to-tr from-blue-100/50 to-transparent opacity-80" />
      <div className="absolute inset-y-0 right-0 w-1/2 bg-gradient-to-l from-purple-100/30 to-transparent opacity-60" />
      <div className="absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r from-green-100/30 to-transparent opacity-50" />
      
      {/* Enhanced animated circles with more vibrant colors */}
      <motion.div 
        className="absolute top-20 right-[10%] w-64 h-64 rounded-full bg-gradient-to-br from-blue-200/40 to-purple-200/30 blur-3xl"
        animate={{ 
          scale: [1, 1.05, 1],
          opacity: [0.5, 0.3, 0.5]
        }}
      ...
      <motion.div 
        className="absolute bottom-20 left-[10%] w-80 h-80 rounded-full bg-gradient-to-tr from-green-200/40 to-blue-200/30 blur-3xl"
        animate={{ 
          scale: [1, 1.1, 1],
          opacity: [0.3, 0.5, 0.3]
        }}
      ...
      <motion.div 
        className="absolute top-[35%] left-[25%] w-40 h-40 rounded-full bg-gradient-to-br from-amber-200/30 to-amber-300/20 blur-2xl"
        animate={{ 
          scale: [1, 1.2, 1],
          opacity: [0.2, 0.4, 0.2]
        }}
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <motion.p 
            className="text-xl sm:text-2xl max-w-3xl mx-auto leading-relaxed text-gray-700 font-light mb-8"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Button 
              size="apple-lg"
              variant="apple"
              className="shadow-lg hover:shadow-xl transition-all hover:scale-[1.02] font-medium text-lg bg-gradient-to-br from-blue-600 to-blue-700 text-white"
              asChild
            >
              <Link to="/all-tools">
                مشاهده همه ابزارها
            ...
            <Button 
              ...
              size="apple-lg"
              className="shadow-sm hover:shadow-md hover:bg-blue-50/50 transition-all hover:scale-[1.02] font-medium text-lg"
              asChild
            >
          ...
          <motion.div 
            className="max-w-lg mx-auto h-1.5 bg-gradient-to-r from-transparent via-blue-400/50 to-transparent mt-16 rounded-full"
            initial={{ scaleX: 0 }}
            animate={{ scaleX: 1 }}
