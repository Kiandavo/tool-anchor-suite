...
export const PersianCulturalSection = () => {
  ...
  return (
    <section className="mb-16 sm:mb-20 animate-slide-up rounded-3xl border border-primary/20 bg-gradient-to-br from-[#E5DEFF]/50 to-[#F8F6FF]" style={{ animationDelay: '0.3s' }}>
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6 sm:mb-10 px-6 sm:px-10 pt-10">
        ...
        <Link to="/category/persian-cultural" className="text-primary flex items-center text-sm font-bold hover:underline mt-2 sm:mt-0">
          مشاهده همه
