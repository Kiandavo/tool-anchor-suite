...
export function Footer() {
  return <footer className="mt-auto py-4 sm:py-6 bg-white border-t">
      <div className="container mx-auto px-2 sm:px-4">
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-right gap-3">
          ...
          <div className="flex items-center space-x-3">
            <a href="https://www.instagram.com/kiandavo" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary transition-colors">
