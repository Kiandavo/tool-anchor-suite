      ...
      <Card className="border-primary/20">
        <CardContent className="p-6">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              لنگر مجموعه‌ای گسترده از ابزارهای آنلاین فارسی است که برای کاربران ایرانی طراحی شده است. 
              ما بیش از {totalTools} ابزار مختلف در {categories.length} دسته‌بندی ارائه می‌دهیم.
            </p>
            <p>
              تمام ابزارهای لنگر آماده استفاده هستند و نیازی به نصب برنامه ندارند. 
              ما به حفظ حریم خصوصی کاربران متعهد بوده و اطلاعات شخصی جمع‌آوری نمی‌کنیم.
            </p>
          </div>
        </CardContent>
      </Card>
          ...
          <div className="space-y-4">
            <div>
              <h4 className="font-medium text-purple-900 mb-2">
                چگونه از ابزارها استفاده کنم؟
              </h4>
              <p className="text-sm text-muted-foreground">
                کافی است ابزار مورد نظر را انتخاب کنید، اطلاعات خواسته شده را وارد کنید و نتیجه را مشاهده کنید.
              </p>
            </div>
            <div>
              <h4 className="font-medium text-purple-900 mb-2">
                آیا داده‌های من محفوظ می‌ماند؟
              </h4>
              <p className="text-sm text-muted-foreground">
                بله، تمام پردازش‌ها در مرورگر شما انجام می‌شود و اطلاعاتی به سرور ارسال نمی‌شود.
              </p>
            </div>
            <div>
              <h4 className="font-medium text-purple-900 mb-2">
                ابزارها روی چه دستگاه‌هایی کار می‌کنند؟
              </h4>
              <p className="text-sm text-muted-foreground">
                تمام ابزارها برای استفاده روی موبایل، تبلت و کامپیوتر بهینه‌سازی شده‌اند.
              </p>
            </div>
          </div>
        </CardContent>
