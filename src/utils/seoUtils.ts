  ...
  const commonFAQs = [
    {
      ...
      answer: `اطلاعات درخواستی را وارد کنید و دکمه اجرا را بزنید. نتیجه بلافاصله نمایش داده می‌شود.`
    },
    {
      question: `آیا داده‌های من محفوظ می‌ماند؟`,
      answer: `بله، تمام پردازش‌ها در مرورگر شما انجام می‌شود و اطلاعاتی ذخیره یا ارسال نمی‌شود.`
    },
    {
      question: `${toolName} روی چه دستگاه‌هایی کار می‌کند؟`,
      answer: `این ابزار طراحی واکنش‌گرا دارد و روی موبایل، تبلت و کامپیوتر قابل استفاده است.`
    }
  ];
